...
int tri_tri_overlap_test_3d(FFLOAT p1[3], FFLOAT q1[3], FFLOAT r1[3], 
...
int coplanar_tri_tri3d(FFLOAT  p1[3], FFLOAT  q1[3], FFLOAT  r1[3],
           FFLOAT  p2[3], FFLOAT  q2[3], FFLOAT  r2[3],
           FFLOAT  N1[3], FFLOAT  N2[3]);


// Two dimensional Triangle-Triangle Overlap Test
int tri_tri_overlap_test_2d(FFLOAT p1[2], FFLOAT q1[2], FFLOAT r1[2], 
          FFLOAT p2[2], FFLOAT q2[2], FFLOAT r2[2]);
...
int tri_tri_overlap_test_3d(FFLOAT p1[3], FFLOAT q1[3], FFLOAT r1[3], 
          ...
          FFLOAT p2[3], FFLOAT q2[3], FFLOAT r2[3])
{
  FFLOAT dp1, dq1, dr1, dp2, dq2, dr2;
  FFLOAT v1[3], v2[3];
  FFLOAT N1[3], N2[3]; 
...
int coplanar_tri_tri3d(FFLOAT p1[3], FFLOAT q1[3], FFLOAT r1[3],
           FFLOAT p2[3], FFLOAT q2[3], FFLOAT r2[3],
           FFLOAT normal_1[3], FFLOAT normal_2[3]){
  
  FFLOAT P1[2],Q1[2],R1[2];
  FFLOAT P2[2],Q2[2],R2[2];
...
{
  FFLOAT dp1, dq1, dr1, dp2, dq2, dr2;
  FFLOAT v1[3], v2[3], v[3];
  FFLOAT N1[3], N2[3], N[3];
  FFLOAT alpha;
...
int ccw_tri_tri_intersection_2d(FFLOAT p1[2], FFLOAT q1[2], FFLOAT r1[2], 
        FFLOAT p2[2], FFLOAT q2[2], FFLOAT r2[2]) {
